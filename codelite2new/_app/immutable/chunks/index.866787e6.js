...
let N = X ? () => window.performance.now() : () => Date.now(),
...
`;
  ...
  f[o] ||
    ((f[o] = !0), h.insertRule(`@keyframes ${o} ${d}`, h.cssRules.length));
...
function wt(t, e, n) {
  ...
  return {
    start() {
      o || ((o = !0), A(t), P(u) ? ((u = u(s)), D().then(d)) : d());
    },
    invalidate() {
      o = !1;
    },
...
function Pt(t, e, n, s, u, a, l = null, i = [-1]) {
  ...
  if (
    ...
    if (e.hydrate) {
      ft();
      const o = T(e.target);
      r.fragment && r.fragment.l(o), o.forEach(W);
