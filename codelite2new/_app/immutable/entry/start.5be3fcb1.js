import { G as me, S as we } from "../chunks/scheduler.3d7b914d.js";
import {
  S as Be,
  a as Je,
  I as M,
  ...
  P as Me,
  h as Ze,
} from "../chunks/singletons.707cde86.js";
function Qe(t, r) {
  return t === "/" || r === "ignore"
    ? t
    : r === "never"
...
function Ot(t, r) {
  ...
  async function ke() {
    ...
    if (n === W && o) {
      ...
      o.props.page !== void 0 && (G = o.props.page), V.$set(o.props);
    }
  }
  function Re(e) {
  ...
  function Pe(e) {
    ...
    s && s.remove(),
      ...
      (V = new t.root({
        target: r,
        props: { ...e.props, stores: H, components: l },
        hydrate: !0,
      })),
      Ae(x);
    const n = {
      ...
      const k = d.branch[I],
        $ =
          ...
          ((k == null ? void 0 : k.loader) !== S[1] ||
            Oe(P, A, L, (B = k.server) == null ? void 0 : B.uses, o));
      return $ && (P = !0), $;
    });
    if (y.some(Boolean)) {
      try {
      ...
      if (b[S])
        try {
          ...
          if (w != null && w.includes(I)) (k = I.status ?? k), ($ = I.error);
            ...
            if (await H.updated.check()) return await K(n);
            $ = await Q(I, { params: o, url: n, route: { id: a.id } });
          }
          const B = await xe(S, F, c);
          return B
            ? await X({
                url: n,
                params: o,
                branch: F.slice(0, B.idx).concat(B.node),
                status: k,
                error: $,
                route: a,
              })
  ...
  async function ce({
    ...
    const P = x;
    b(), (U = !0), T && H.navigating.set(A.navigation), (W = _);
    let y = L && (await he(L));
    if (!y) {
  ...
  return {
    ...
    apply_action: async (e) => {
      if (e.type === "error") {
        ...
        e.type === "redirect"
          ...
          : (V.$set({
              form: null,
              page: { ...G, form: e.data, status: e.status },
            }),
            await we(),
            V.$set({ form: e.data }),
            e.type === "success" && Ee());
    ...
    _start_router: () => {
      ...
      addEventListener("pageshow", (n) => {
        n.persisted && H.navigating.set(null);
      });
      function e(n) {
        (d.url = n), H.page.set({ ...G, url: n }), H.page.notify();
      }
    },
    _hydrate: async ({
      status: e = 200,
